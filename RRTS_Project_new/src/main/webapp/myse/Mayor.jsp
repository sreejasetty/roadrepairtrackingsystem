    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar">
            ...
            <ul class="nav flex-column">
          		...
          		<li class="nav-item">
                    <a class="nav-link active" href="${pageContext.request.contextPath}/MayorProfile">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="MayorOverview.jsp">
                        <i class="fas fa-file-alt"></i>  Overview of Complaints
                    </a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link" href="MayorStatistics.jsp">
                        <i class="fas fa-file-alt"></i> Statistics Dashboard
                    </a>
                </li>
                <li class="nav-item">
	...
	<% Login_details details = new Login_details(); %>
        ...
        <div class="col-md-9 col-lg-10 main-content" id="main">
            <div class="container">
                ...
                <h5>Mayor Guidelines:</h5>
                <ul>
                    <li>Ensure to verify and process complaints promptly.</li>
                    <li>Keep track of complaint statuses and update residents accordingly.</li>
                    <li>Maintain accurate records of all complaints and actions taken.</li>
                    <li>Use the settings page to update your profile and preferences.</li>
                    <li>Contact support if you encounter any issues with the system.</li>
                </ul>
            </div>
</div>
<!-- Footer -->
