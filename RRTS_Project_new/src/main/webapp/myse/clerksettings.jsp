    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="clerksettings.jsp">
        ...
        <div class="col-md-9 col-lg-10 main-content" id="main">
            <div class="container">
                <h1>Clerk Settings</h1>
                <div class="card mt-3">
                    <div class="card-header">
                        Update Your Information
                    </div>
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/change_clerk_settings">
