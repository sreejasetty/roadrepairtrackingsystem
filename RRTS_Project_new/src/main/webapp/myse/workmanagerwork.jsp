...
<meta charset="UTF-8">
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Workmanager Requests</title>
    <!-- Bootstrap CSS -->
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Total Machinery</th>
                                    <th scope="col">Total Manpower</th>
                                    <th scope="col">Assigned Machinery</th>
                                    <th scope="col">Assigned Manpower</th>
                                    <th scope="col">Requested Machinery</th>
                                    <th scope="col">Requested Manpower</th>
                                    <th scope="col">Submit</th>
                                </tr>
                            </thead>
                            <% while (rs.next()) { %>
                            <form action="${pageContext.request.contextPath}/request_administrator?location=<%= rs.getString("location") %> " method="post">
                            <tbody>
                                <tr>
                                    ...
                                    <td><%= rs.getInt(9) %></td>
                                    <td><%= rs.getInt(10) %></td>
                                    <td><input type="number" class="form-control" name="requestedMachinery" placeholder="Enter amount"></td>
                                    <td><input type="number" class="form-control" name="requestedManpower" placeholder="Enter amount"></td>
                					
                                    <td>
                                   		 <input type="hidden" name="username" value="<%= rs.getString("name") %>">
